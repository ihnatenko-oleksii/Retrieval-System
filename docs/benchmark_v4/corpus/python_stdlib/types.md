...
Official source: https://docs.python.org/3/library/types.html
...
MappingProxyTypes are generic over two types, signifying (respectively) the types of the underlying mapping’s keys and values.
