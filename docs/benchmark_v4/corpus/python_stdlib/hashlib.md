...
Official source: https://docs.python.org/3/library/hashlib.html
...
Changed in version 3.14: Now raises a BlockingIOError if the file is opened in non-blocking mode. Previously, spurious null bytes were added to the digest.
