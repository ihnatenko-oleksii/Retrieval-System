...
Official source: https://docs.python.org/3/library/sqlite3.html
...
Changed in version 3.14: ProgrammingError is emitted if named placeholders are used and the items in parameters are sequences instead of dicts.
